...
CREATE TABLE IF NOT EXISTS `Document` (
  ...
  `storageProvider` VARCHAR(50) NULL DEFAULT 'local',
  `publicUrl` VARCHAR(500) NULL,
  `version` INT NOT NULL DEFAULT 1,
  `status` ENUM('DRAFT','PENDING','UNDER_REVIEW','APPROVED','REJECTED','PUBLISHED','ARCHIVED','EXPIRED') NOT NULL DEFAULT 'PENDING',
