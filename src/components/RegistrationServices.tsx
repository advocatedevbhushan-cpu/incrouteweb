...
const IndiaMap = React.memo(({ hoveredCity, setHoveredCity }: IndiaMapProps) => {
  return (
    <div 
      className="absolute top-0 right-0 w-[58%] sm:w-[50%] h-full pointer-events-none z-[1] overflow-hidden"
      style={{
    ...
    >
      {/* Glowing vector outline and animated routes representing India's geography */}
      <svg 
        viewBox="0 0 612 696" 
        className="w-full h-full opacity-45 sm:opacity-75 pointer-events-auto cursor-default" 
      ...
      >
        ...
        {/* Geographically precise, optimized administrative states of India */}
        <g>
          {INDIA_STATES.map((state) => (
            <path 
              ...
              className="transition-all duration-300 hover:fill-brand-gold/15 hover:stroke-brand-gold cursor-default"
            />
          ))}
        </g>
        ...
        {/* Animated Pulsing Neon Flow Lasers */}
        <g fill="none">
          <path d="M 185,540 Q 140,370 187,211" stroke="url(#neon-laser-grad)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="15, 150">
            <animate attributeName="stroke-dashoffset" values="165;0" dur="3.5s" repeatCount="indefinite" />
          </path>

          <path d="M 112,412 Q 135,480 185,540" stroke="url(#neon-laser-grad)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="10, 100">
            <animate attributeName="stroke-dashoffset" values="110;0" dur="2.4s" repeatCount="indefinite" />
          </path>

          <path d="M 425,345 Q 300,250 187,211" stroke="url(#neon-laser-grad)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="15, 120">
            <animate attributeName="stroke-dashoffset" values="135;0" dur="3s" repeatCount="indefinite" />
          </path>

          <path d="M 238,575 Q 170,490 112,412" stroke="url(#neon-laser-grad)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="15, 150">
            <animate attributeName="stroke-dashoffset" values="165;0" dur="4s" repeatCount="indefinite" />
          </path>

          <path d="M 235,455 Q 200,330 187,211" stroke="url(#neon-laser-grad)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="10, 100">
            <animate attributeName="stroke-dashoffset" values="110;0" dur="2.8s" repeatCount="indefinite" />
          </path>
        </g>
        ...
        {/* Major Active Cities (Interactive) */}
        {Object.entries(CITY_STATS).map(([key, city]) => {
          ...
          return (
            ...
            >
              {isHovered && (
                <circle cx={city.x} cy={city.y} r="8" fill="none" stroke="#C7A86B" strokeWidth="0.8">
              ...
              <circle cx={city.x} cy={city.y} r={isHovered ? "8" : "6"} fill="none" stroke="#C7A86B" strokeWidth="0.5" opacity="0.4">
        ...
        <>
          ...
          >
            ...
            <div 
              ...
              className="absolute bottom-6 right-6 sm:bottom-8 sm:right-8 z-10 block cursor-pointer group"
            >
