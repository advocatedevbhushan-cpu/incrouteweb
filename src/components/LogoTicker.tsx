...
export default function LogoTicker() {
  const logos = [
    // Stripe
    {
      name: "Stripe",
      svg: (
        <svg className="h-6 w-auto" viewBox="0 0 80 33" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    // Zoho
    {
      name: "Zoho",
      svg: (
        <svg className="h-6 w-auto" viewBox="0 0 90 26" fill="none" xmlns="http://www.w3.org/2000/svg">
