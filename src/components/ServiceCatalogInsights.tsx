...
const advantageSpectrum = [
  ...
  { icon: Users, title: "Dedicated Expert Assigned", desc: "Every engagement is handled by Advocate Dev Bhushan personally — not outsourced to junior staff or automated pipelines." },
];
